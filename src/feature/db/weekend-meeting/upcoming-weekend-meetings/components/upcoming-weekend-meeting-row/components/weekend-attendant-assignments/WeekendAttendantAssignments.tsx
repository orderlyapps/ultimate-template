...
export const WeekendAttendantAssignments: FC<Props> = ({ weekId }) => {
    ...
    q
      ...
      .where(({ av }) =>
        and(
          ...
          or(
            eq(av.assignment_id, "entrance_weekend"),
            eq(av.assignment_id, "auditorium_weekend"),
            eq(av.assignment_id, "zoom_weekend"),
          ),
        ),
      )
      .select(({ av, p }) => ({
